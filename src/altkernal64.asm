...
load_address = $a000  ; just an example

		; switch off BASIC ROM (we dont need it anymore
		LDA #$36
		STA $01
...
error_done:
        jmp error_done	; forever loop

fname:  .TEXT "BOOT"
fname_end:

btr_err_msg:
.text "NO OPERATING SYSTEM ERROR"
.byte $00
...
A_FCEF                                  ;                               [FCEF]
        ...
        jmp     $E000 ;(BasicCold)             ; execute BASIC
